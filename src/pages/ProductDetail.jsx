...
//               alt={`${product.productname} view ${currentImage + 1}`}
...
//               <span className="ml-4 text-sm text-red-600 uppercase">Out of stock</span>
//             )}
//           </div>
...
//             <button
//               className="bg-gray-200 text-gray-800 py-3 px-8 rounded-md font-medium hover:bg-gray-300 flex-grow text-center"
...
//                   <p className="mt-2"><strong>Category:</strong> {product.category?.categoryname}</p>
//                   <p className="mt-2"><strong>Gender:</strong> {product.gender}</p>
//                   <p className="mt-2"><strong>Material:</strong> Premium leather with suede overlay</p>
//                 </div>
//               )}
...
//                   <p className="mt-2">Estimated delivery time: 3-7 business days.</p>
...
//                   <div key={relatedProduct.id} className="border rounded-md p-2 cursor-pointer hover:shadow-md">
//                     <h4 className="font-medium text-gray-900">{relatedProduct.productname}</h4>
//                     <p className="text-sm text-gray-500 mt-1">₩{relatedProduct.price.toLocaleString()}</p>
//                   </div>
//                 ))}
//               </div>
//             </div>
...
//           const firstAvailableSize = productData.stock.find(item => item.stock_quantity > 0);
...
//     if (selectedSizeObj) {
//       alert(`Added to cart: ${product.productname}, Size: US ${selectedSizeObj.us_size} (${selectedSizeObj.gender}), Quantity: ${quantity}`);
//     } else {
//       alert(`Added to cart: ${product.productname}, Size ID: ${selectedSize}, Quantity: ${quantity}`);
//     }
...
//             <img
//               src={imageArray[currentImage]}
//               alt={`${product.productname || 'Product'} view ${currentImage + 1}`}
//               className="w-full h-auto rounded-lg"
//             />
...
//         {/* Product Details */}
//         <div className="w-full lg:w-1/2">
//           <p className="text-sm text-gray-500 uppercase mb-2">{product.brand || 'Brand'}</p>
//           <h1 className="text-xl font-bold text-gray-900">{product.productname || 'Product Name'}</h1>

//           <div className="mt-4">
//             {product.discount ? (
//               <div className="flex items-center gap-2">
//                 <span className="text-xl font-bold text-gray-900">{formatPrice(getDiscountedPrice())}</span>
//                 <span className="text-sm text-gray-500 line-through">{formatPrice(getPrice())}</span>
//                 <span className="text-sm text-red-600">-{product.discount}%</span>
//               </div>
//             ) : (
//               <span className="text-xl font-bold text-gray-900">{formatPrice(getPrice())}</span>
//             )}
...
//                 <button
//                   key={sizeItem.id}
//                   onClick={() => sizeItem.available && setSelectedSize(sizeItem.id)}
//                   className={`
//                     py-2 px-4 border rounded-md text-center min-w-[60px]
//                     ${selectedSize === sizeItem.id ? 'border-black' : 'border-gray-300'}
//                     ${!sizeItem.available ? 'opacity-50 cursor-not-allowed bg-gray-100' : 'hover:border-black'}
//                   `}
//                   disabled={!sizeItem.available}
//                   title={!sizeItem.available ? 'Out of stock' : `${sizeItem.stock} in stock`}
//                 >
//                   {sizeItem.us_size}
//                 </button>
//               ))}
//             </div>
//             <div className="mt-1">
//               <a href="#" className="text-xs text-gray-500 hover:underline" onClick={(e) => {
//                 e.preventDefault();
...
//                 onClick={increaseQuantity}
//                 className="px-3 py-2"
//                 disabled={isOutOfStock() || !selectedSize || (selectedSize && getStockForSize(selectedSize) <= quantity)}
//               >
//                 +
//               </button>
//             </div>
...
//                   <p className="mt-2"><strong>Category:</strong> {product.category?.categoryname || 'N/A'}</p>
//                   <p className="mt-2"><strong>Gender:</strong> {product.gender || 'N/A'}</p>
//                   {product.gender === 'Men' && (
//                     <p className="mt-2"><strong>Sizes:</strong> US 7-13 Men's</p>
//                   )}
//                   {product.gender === 'Women' && (
//                     <p className="mt-2"><strong>Sizes:</strong> US 6-11 Women's</p>
//                   )}
//                   {product.gender === 'Unisex' && (
//                     <p className="mt-2"><strong>Sizes:</strong> US 7-13 Men's / US 6-11 Women's</p>
//                   )}
//                 </div>
//               )}
