        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-lg shadow lg:col-span-2">
            ...
            <div className="p-6">
              <div className="flex flex-wrap justify-between mb-6">
                ...
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    ...
                    <div>
                      <span className={`px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${order.payment_status === 'Paid' ? 'bg-blue-100 text-blue-800' : 'bg-red-100 text-red-800'
                        }`}>
              ...
              {/* Order Items - Standardized table */}
          ...
          <div className="space-y-6">
            ...
            {/* Update Order Status - Standardized styles */}
            <div className="bg-white rounded-lg shadow">
              <div className="px-6 py-4 border-b">
              ...
              <div className="p-6">
                ...
                {/* Standardized button - primary (black) */}
                <button
                  onClick={updateOrderStatus}
                  disabled={newStatus === order.shipment_status}
                  className={`w-full px-4 py-2 rounded-md text-white ${newStatus === order.shipment_status
              ...
              <div className="p-6">
                <div className="relative">
                  ...
                  <div className="relative mb-6">
                    <div className="flex items-start">
                      <div className="flex items-center justify-center h-8 w-8 rounded-full bg-gray-100 text-gray-600 mr-4 z-10">
                        <Calendar size={16} />
                      </div>
                      <div>
