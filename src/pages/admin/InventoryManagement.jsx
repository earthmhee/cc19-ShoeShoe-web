          ...
          <div className="flex flex-wrap gap-2">
            ...
            <div className="relative">
              <select
                ...
                className="appearance-none pl-10 pr-8 py-2 border border-gray-300 rounded-md leading-5 bg-white focus:outline-none focus:ring-gray-500 focus:border-gray-500 sm:text-sm"
              >
                                ...
                                {editing ? (
                                  <div className="flex items-center p-2 border border-gray-300 rounded-md bg-white shadow-sm">
                                    ...
                                    <input
                                      ...
                                      className="w-16 p-1 text-center border border-gray-300 rounded focus:ring-gray-500 focus:border-gray-500"
                                    />
                                    <button
