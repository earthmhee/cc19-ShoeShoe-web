...
import { getProducts, getCategories, updateStock, getSizes } from '../../services/api';
  ...
  const saveStockChange = async (product, sizeId) => {
    ...
    try {
      ...
      if (existingStockItem) {
        ...
        await updateStock(existingStockItem.id, newQuantity);
      } else {
        // Create new stock entry - this would require a new API endpoint
        console.log('Creating new stock entry', { product_id: product.id, size_id: sizeId, stock_quantity: newQuantity });
        // await createStock({ product_id: product.id, size_id: sizeId, stock_quantity: newQuantity });
      }
