  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto p-4">
        {/* Content */}
        <div className="mt-8">
          <h1 className="text-2xl font-light mb-2" style={{ fontFamily: "'Lexend', sans-serif" }}>
            NEW COLLECTION
          </h1>
          <h2 className="text-3xl font-light mb-8" style={{ fontFamily: "'Lexend', sans-serif" }}>
            NEW ARRIVAL
          </h2>
                  ...
                  <div className="relative overflow-hidden bg-gray-50 aspect-square">
                    ...
                    {product.isNew && (
                      <div className="absolute top-2 left-2">
                        <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-light bg-black text-white"
