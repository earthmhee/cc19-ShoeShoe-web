...
const AccountSidebar = () => {
	...
	return (
		<div className="w-full border border-gray-200 lg:max-w-[350px]">
			<div
				...
				<div className="divide-y divide-gray-200">
					{menuItems.map((item) => (
						<div
							...
							onClick={() => {
								handleMenuItemClick(item.label), navigate(item.navigate);
							}}
						>
							<span
								className={`text-sm ${
									activeItem === item.label ? "text-gray-800" : "text-gray-500"
								}`}
							>
