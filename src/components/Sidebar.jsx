...
// import { ShoeshoeLogo } from "../icons"; // Replace with your logo component
// import CartIcon from "./CartIcon"; // Replace with your cart icon component
// import UserProfileForNavBar from "./UserProfileForNavBar";
// function ResponsiveNavigation() {
//   const [isOpen, setIsOpen] = useState(false);
//   const [language, setLanguage] = useState("TH");
...
//         className={`fixed inset-y-0 left-0 transform ${
//           isOpen ? "translate-x-0" : "-translate-x-full"
//         } lg:hidden transition duration-200 ease-in-out z-40 w-64 bg-white shadow-lg overflow-y-auto`}
//         aria-hidden={!isOpen}
//       >
//         <div className="flex flex-col h-full">
//           {/* Close Button */}
...
//               <div
//                 key={item.id}
//                 className="py-3 px-4 font-bold text-sm border-b border-gray-200 cursor-pointer"
...
//       {isOpen && (
//         <div
//           className="lg:hidden fixed inset-0 bg-black/[70%] bg-opacity-50 z-30"
//           onClick={toggleSidebar}
//           aria-hidden="true"
//         ></div>
//       )}
